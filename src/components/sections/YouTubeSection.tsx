...
const videos = [
  {
    id: 1,
    title: "How to Customize Acrylic Photo Frames - Complete Guide",
  ...
  {
    id: 2,
    title: "Corporate Gift Ideas 2024 - Top 10 Trending Products",
    thumbnail: "https://images.unsplash.com/photo-1549465220-1a8b9238cd48?w=400&h=225&fit=crop",
    duration: "8:32",
    views: "89K",
    likes: "3.1K",
    date: "1 month ago",
  ...
  {
    id: 3,
    title: "T-Shirt Printing Process - Behind the Scenes",
    thumbnail: "https://images.unsplash.com/photo-1562157873-818bc0726f68?w=400&h=225&fit=crop",
    duration: "15:20",
    views: "67K",
    likes: "2.8K",
    date: "3 weeks ago",
  ...
  {
    id: 4,
    title: "Night Lamp Customization Tutorial - LED Acrylic Lamps",
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6 mb-12">
          <div className="text-center md:text-left">
            ...
            <p className="mt-2 text-muted-foreground max-w-lg">
              Learn about our products, customization process, and get inspired with our video tutorials.
            </p>
          </div>
          <Button
            size="lg"
          ...
          {videos.map((video) => (
            ...
            >
              ...
              <div className="relative aspect-video overflow-hidden">
                ...
                {/* Duration Badge */}
                <div className="absolute bottom-2 right-2 bg-foreground/80 text-primary-foreground text-xs font-medium px-2 py-1 rounded">
                  {video.duration}
                </div>
              ...
              {/* Content */}
              <div className="p-4">
                <h4 className="text-sm font-semibold text-foreground line-clamp-2 mb-3 group-hover:text-primary transition-colors">
                  {video.title}
                </h4>
        ...
        <div className="mt-12 bg-gradient-to-r from-red-600 to-red-500 rounded-2xl p-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h4 className="text-xl font-bold text-white">Our YouTube Channel</h4>
                <p className="text-white/80 text-sm">Subscribe for latest updates & tutorials</p>
              </div>
            </div>
