...
const fallbackCategories: Category[] = [
  ...
  { id: "name-pencils", name: "Name Pencils", image_url: "https://images.unsplash.com/photo-1513542789411-b6a5d4f31634?w=400&h=400&fit=crop", video_url: null, slug: "name-pencils", products_count: 50 },
];
...
export const CategoryCircles = () => {
  ...
  const getCategoryHref = (slug: string) => {
    ...
    const slugRouteMap: Record<string, string> = {
      ...
      'clear-acrylic-photo': '/category/acrylic',
      'framed-acrylic-photo': '/category/acrylic',
      'acrylic-night-lamp': '/category/acrylic',
      'acrylic-table-stand': '/category/acrylic',
      'acrylic-wall-clock': '/category/wall-clocks',
    };
    return slugRouteMap[slug] || `/category/${slug}`;
  };
