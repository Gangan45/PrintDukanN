      ...
      <div className="container mx-auto px-3 sm:px-4 py-4 sm:py-6">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-3 sm:gap-4 text-xs sm:text-sm text-primary-foreground/60">
          ...
          <div className="flex items-center gap-3 sm:gap-4">
            ...
            <img src={mastercardLogo} alt="Mastercard" className="h-6 sm:h-8 object-contain" />
            <img src={upiLogo} alt="UPI" className="h-6 sm:h-8 object-contain" />
            <img src={rupayLogo} alt="RuPay" className="h-6 sm:h-8 object-contain" />
          </div>
        </div>
      </div>
    </div>
