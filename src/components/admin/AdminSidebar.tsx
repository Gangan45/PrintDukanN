import { LayoutDashboard, Package, ShoppingCart, FolderTree, Settings, ArrowLeft, Users, Warehouse, Ticket, Star, FileStack, Film, ImageIcon, Youtube, Sparkles, LogOut } from "lucide-react";
...
const menuItems = [
  ...
  { title: "Videos", url: "/admin/videos", icon: Youtube },
